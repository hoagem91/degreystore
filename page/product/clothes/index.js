...
addToCartButtons.forEach((button) => {
  button.addEventListener("click", (e) => {
    ...
    const product = button.closest(
      ".product,.product-one,.product-two,.product-three,.product-four,.product-five,.product-six,.product-seven,.product-eight,.product-nine,.product-ten,.product-eleven,.product-twelve,.product-thirdteen,.product-fourteen"
    );
    const productInfo = {
      id: Date.now(),
